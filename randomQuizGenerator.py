# randomQuizGenerator.py - Creates quizes with questions and answers in random order, along with the answer key.
# random order, along with the answer key.

import random

# The quiz data. Keys are states and values are capitols.
capitals = {'Alabama': 'Montgomery', 'Alaska': 'Juneau', 'Arizona': 'Phoenix',
            ...
            'Frankfurt', 'Louisiana': 'Baton Rouge', 'Maine': 'Augusta', 'Maryland': 'Annapolis',
...
for quizNum in range(35):
      ...
      #Write out the header for the quiz and answer files.
      quizFile.write('Name:\n\nDate:\n\n')
      quizFile.write((' ' * 20) + 'State Capitals Quiz (Form %s)' % (quizNum + 1))
      quizFile.write('\n\n')
      answerKeyFile.write('State Capitals Quiz (Form %s) - Answers\n\n' % (quizNum + 1))
